#
# compute lagged correlations between SST and precip in MC2 MC12 and observed data (for figure 13)
#
...
#    for year in range(2007,2019):
    for year in [2003,2005,2007,2009,2012,2014,2015,2016,2017,2018]:
        ...
        t = iris.load_cube("/work/scratch-pw2/emmah/%s_temp_%d.nc"%(model,year))
        t.data.mask = t.data.mask + t.data < 10 # mask land. Note units are Kelvin
        mask_t = t.data.mask
        mask_p = p.data.mask
    ...
    iris.save(corr,"/work/scratch-pw2/emmah/corr_%s_0p5.nc"%(model))
