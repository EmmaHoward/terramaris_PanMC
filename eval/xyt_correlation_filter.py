...
years = [2003,2014,2016,2017,2018]
...
#  correl_u850,correlx_u850,correlt_u850 = band_regress(u12[:,:90,1],uobs[:,:,0])
...
#  pickle.dump((correl_u200,correlx_u200,correlt_u200),open(scratchpath+"correl_u_200.pickle","wb"))
