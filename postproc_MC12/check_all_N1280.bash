...
for date in  "20181225" 
do
  JID_check=`sbatch $queue -o /home/users/emmah/log/N1280_$date.o -e /home/users/emmah/log/N1280_$date.e -t 01:00:00 /home/users/emmah/python/postproc_coupled/check_N1280.py $date | cut -d " " -f 4`
done
